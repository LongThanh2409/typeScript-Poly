            ...
            <div className="lg:flex  lg:justify-between">
                ...
                <div className=" flex lg:mt-0 lg:ml-10 ">
                    <div className="max-w-2xl flex flex-col justify-between">
                        ...
                        <div className="mt-4">
                            <span className="mt-1 text-2xl  font-semibold text-red-500">$999.00</span>   <span className="mt-1 ml-1 text-sm font-semibold text-gray-500">$999.00</span>
                            <p className=" text-sm font-sans text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse cursus lacus ut nulla malesuada, eget egestas quam ultricies. Praesent vitae imperdiet ipsum, sed dignissim velit.</p>
                        </div>
